...
type ClientPOS interface {
	...
	GetLatestAuctionInfoV2(ctx context.Context) (StateGetAuctionInfoResultV2, error)
	// GetAuctionInfoV2ByHash returns the types.ValidatorBid and types.EraValidators of either a specific Block by hash
	GetAuctionInfoV2ByHash(ctx context.Context, blockHash string) (StateGetAuctionInfoResultV2, error)
	// GetAuctionInfoV2ByHeight returns the types.ValidatorBid and types.EraValidators of either a specific Block by height
	GetAuctionInfoV2ByHeight(ctx context.Context, height uint64) (StateGetAuctionInfoResultV2, error)
